...
let copyArr3 = util.copyArray(randomArr)
...
SortTestHelper.testSort('QuickSort', QuickSort.sort, copyArr2)
SortTestHelper.testSort('QuickSort 3 Ways', QuickSort.sort3Ways, copyArr3)